import {INIT_TEST, RIGHT_ANSWERS, RESULT_COUNTER, REST_TO_FINISH} from "../actionTypes";
...
export const reducerUser = (state = initialState, action) => {
    switch (action.type) {
        case INIT_TEST:
            return {...state, result: {...state.result, currentTest: action.payload, numOfRestQuestions: action.payload.length} }
